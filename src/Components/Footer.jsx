    ...
    <>
      <footer className="w-screen flex flex-wrap p-3 z-20" style={{background:"rgba(53, 59, 72,1.0)"}}>
        ...
        <div className="lg:w-3/5  p-2 flex justify-center flex-col gap-2 sm:w-screen">
            ...
            <h4 className="text-white text-xl font-serif text-center ms-14 lg:w-3/5">Nexus.Powered By<span className="text-red-400 text-xl ms-1 font-serif font-bold">Mobirisw</span> </h4>
        </div>
